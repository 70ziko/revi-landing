...
const Hero = () => {
  ...
  return (
    <Box
      sx={{
        background:
          "linear-gradient(180deg, rgba(74, 139, 224, 0.15) 20%, rgb(27, 27, 27) 110%)",
        pt: { xs: 12, md: 24 },
        pb: { xs: 8, md: 12 },
        pl: { xs: 2, sm: 12 },
      }}
        ...
        >
          ...
          <Box sx={{ flex: 1, textAlign: { xs: "center", md: "left" } }}>
            <Typography
              ...
              sx={{
                background:
                  "linear-gradient(90deg,rgb(47, 64, 215) 0%, #10b981 100%)",
            ...
            >
              Make informed shopping decisions instantly with AI-powered product
              analysis
            </Typography>
            <Stack
            ...
            >
              {!submitted ? (
                ...
                >
                  Thank you for joining the waitlist! We will notify you when we
                  launch.
                </Typography>
              )}
